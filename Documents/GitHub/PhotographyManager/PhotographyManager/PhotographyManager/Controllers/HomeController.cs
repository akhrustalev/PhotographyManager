...
namespace PhotographyManager.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult BlockOfPhotos(List<Photo> model)
        {
            return PartialView("BlockOfPhotos", model);
        }
        ...
        public ActionResult Search()
        {
            ...
            return View("BlockOfPhotos",searchResult);
        }
        ...
        public ActionResult AddEditedProperties(int id)
        {
            ...
            //bool flash = Convert.ToBoolean(Request.Form["Flash"].ToString());
